...
> Think!
> 
> The diagram above a 3-Way SA cache with 4 distinct **sets**. How many LRU bits are needed per cache line? How many LRU bits are needed in the **entire** cache hardware? 
